...
|  | AMS1117-1.5/-1.8/-2.5/-$2.85$ | $\begin{aligned} & \mathrm{f}=120 \mathrm{~Hz}, \mathrm{C}_{\text {OUT }}=22 \mu \mathrm{~F} \text { Tantalum, } \mathrm{I}_{\text {OUT }}=1 \mathrm{~A}, \\ & \mathrm{~V}_{\text {IN }}=4.35 \mathrm{~V} \end{aligned}$ | 60 | 72 |  | dB |
